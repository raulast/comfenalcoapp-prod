...
class Reporteips extends Component {
    constructor(props) {
        super(props);
        this.state = {
           ips:'',
...
export default Reporteips;

if (document.getElementById('reportesContentIps')) {
    ReactDOM.render(<Reporteips/>, document.getElementById('reportesContentIps'));
}